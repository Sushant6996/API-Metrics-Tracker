...
public class TransactionService {
    ...
    public void logTransaction(long transactionId, String transactionType, int quantity, double transactionPrice,
                               ...
                               String contractUnderlyingAsset, long responseTime, int statusCode) {
        try {
...
//
            ...
            TransactionMetrics transactionMetrics = calculateMetrics(transaction, responseTime, statusCode);
    ...
    private TransactionMetrics calculateMetrics(Transaction transaction, long responseTime, int statusCode) {
